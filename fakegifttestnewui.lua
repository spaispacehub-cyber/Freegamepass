...
SPAISPACEHUBZZZ fake gift v2 (Native UI & Assets Refreshed)
--]]
...
local function showBuyModal(productInfo, recipient)
    ...
    -- Info alignment block matching native layout structure
    ...
    priceRow.Position = UDim2.fromOffset(0, 22)
    priceRow.Size     = UDim2.new(1, 0, 0, 22)
    priceRow.BackgroundTransparency = 1
    priceRow.ZIndex   = 4
    priceRow.Parent   = infoGroup

    robuxIcon(priceRow, 16, UDim2.new(0, 0, 0.5, 0), 4)
    priceRow.ImageLabel.AnchorPoint = Vector2.new(0, 0.5)

    local priceLbl = Instance.new("TextLabel")
    priceLbl.BackgroundTransparency = 1
    priceLbl.Size     = UDim2.new(1, -22, 1, 0)
    priceLbl.Position = UDim2.fromOffset(22, -1)
...
print("[SPACEHUB] Loaded! UI Theme and Asset IDs updated. Logic locked down flawlessly.")
