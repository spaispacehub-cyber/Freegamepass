--[[
SPAISPACEHUBZZZ fake gift v3 (Sharp Numbers + New IDs + NEW Badge + Static Checkmark)
--]]
...
-- ID ĐÃ ĐƯỢC CẬP NHẬT THEO YÊU CẦU
local CHECKMARK_ID   = "rbxassetid://17829956139"
local ROBUX_ID       = "rbxassetid://11560341145"
local CLOSE_X_ID     = "rbxassetid://4988112413"
local ROBLOX_PLUS_ID = "rbxassetid://138882818765521"

local FONTS = {
    Main = Enum.Font.BuilderSans,
    Bold = Enum.Font.BuilderSansBold,
    Num  = Enum.Font.GothamBold, -- Font nét căng dành riêng cho số tiền
}
...
-- ============================================================
--  PURCHASE COMPLETED MODAL (CHECKMARK ĐÃ SỬA)
-- ============================================================
local function showPurchaseDone(productInfo, recipient)
    ...
    -- FIXED: CHECKMARK SIZE NHỎ HƠN & BỎ HIỆU ỨNG ZOOM
    local CH_SIZE = 54 
    local ch = Instance.new("Frame")
    ch.Size        = UDim2.fromOffset(CH_SIZE, CH_SIZE) -- Cố định kích thước luôn
...
local function showBuyModal(productInfo, recipient)
    ...
    -- FIXED: Font số nét căng (FONTS.Num)
    ...
    footerTxt.Size             = UDim2.fromOffset(168, 52) -- Chiều ngang vừa khít với chữ
    ...
    -- FIXED: Bổ sung chữ NEW bên cạnh
    local newBadge = Instance.new("Frame")
    newBadge.Size             = UDim2.fromOffset(36, 18)
    newBadge.Position         = UDim2.fromOffset(222, 17) -- Căn sát bên phải của footerTxt
    newBadge.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    newBadge.BackgroundTransparency = 0.88 -- Hơi trong suốt mờ mờ chuẩn dark mode
