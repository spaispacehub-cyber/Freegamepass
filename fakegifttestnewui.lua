--[[
SPAISPACEHUBZZZ fake gift v5 (Sharp UI + Static Checkmark + Gamepass Gift FIX + Old Settings + Processing UI Fixed 100% No Errors)
--]]
...
local function playInitLoading()
    ...
    task.wait(0.2)
    if loadGui.Parent then loadGui:Destroy() end
end

task.spawn(playInitLoading) -- Chạy loading song song không làm kẹt script
